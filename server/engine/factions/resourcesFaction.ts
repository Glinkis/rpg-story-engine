...
import { dice, randomRange, randomValue, pluck } from "../rolls"
...
export function resourcesFaction (faction: Faction) {
    ...
    if (faction.roll.resources > 95) {
      ...
      for (i = 1; i <= 5; ++i) { faction.resources.push(getResources(randomRange(-10, 15))) }
    } else if (faction.roll.resources > 90) {
      faction.resourcesDescription = 'near limitless'
      for (i = 1; i <= 4; ++i) { faction.resources.push(getResources(randomRange(-10, 10))) }
    } else if (faction.roll.resources > 80) {
      faction.resourcesDescription = 'extensive'
      for (i = 1; i <= 4; ++i) { faction.resources.push(getResources(randomRange(-15, 5))) }
    } else if (faction.roll.resources > 70) {
      faction.resourcesDescription = 'significant'
      for (i = 1; i <= 4; ++i) { faction.resources.push(getResources(randomRange(-20, 5))) }
    } else if (faction.roll.resources > 60) {
      faction.resourcesDescription = 'many'
      for (i = 1; i <= 3; ++i) { faction.resources.push(getResources(randomRange(-10, 5))) }
    } else if (faction.roll.resources > 55) {
      faction.resourcesDescription = 'decent'
      for (i = 1; i <= 3; ++i) { faction.resources.push(getResources(randomRange(-15, 5))) }
    } else if (faction.roll.resources > 50) {
      faction.resourcesDescription = 'average'
      for (i = 1; i <= 3; ++i) { faction.resources.push(getResources(randomRange(-20, 5))) }
