...
export function createNPC(town: Town, base?: any) {
                                                    if (!town) {
                                                      console.error(
                                                        `Town is not defined! NPC cannot be created. Please report this bug.`
                                                      )
                                                    }
                                                    ...
                                                    const profession =
                                                      base.profession || fetchProfessionChance(town, base)

                                                    const firstName =
                                                      base.firstName ||
                                                      toUpperFirst(
                                                        randomValue(raceTraitsData[race].genderTraits[gender].firstName)
                                                      )
                                                    const lastName =
                                                      base.lastName ||
                                                      toUpperFirst(randomValue(raceTraitsData[race].lastName))
                                                    const ageStage =
                                                      base.ageStage ||
                                                      randomValue([
                                                        `young adult`,
                                                    ...
                                                    const npc = {
                                                      ...
                                                      ageStage,
                                                      ageYears:
                                                        raceTraits.ageTraits[ageStage].baseAge +
                                                        raceTraits.ageTraits[ageStage].ageModifier(),
                                                      ...
                                                      roll: {
                                                        ...
                                                        wageVariation(town: Town) {
                                                          ...
                                                          return calcPercentage(
                                                            npc.roll._wageVariation,
                                                            (town.roll.wealth - 50) / 5
                                                          )
                                                        },
                                                      },
                                                      ...
                                                      set descriptorsAdd(description: any) {
                                                        if (typeof description === `string`) {
                                                          ...
                                                          console.log(
                                                            `Expected a string operand and received ${description}`
                                                          )
                                                        }
                                                      },
                                                    ...
                                                    if (npc.hasClass === undefined) {
                                                      if (random(100) > 70) {
                                                        ...
                                                        npc.adventure =
                                                          randomValue(npcData.adventure) || `looking for work`
                                                        npc.hasClass = true
                                                      }
                                                    ...
                                                    if (physicalTraitRoll > 40) {
                                                      npc.physicalTrait =
                                                        npc.physicalTrait ||
                                                        randomValue([hair, eyes, nose, mouth, chin, ears, headMisc])
                                                      ...
                                                      npc.physicalTrait =
                                                        npc.physicalTrait || randomValue(npcData.tattoo)
                                                    }
                                                    ...
                                                    npc.profile = (npc: any, base: any) => {
                                                      base = npc.name || base
                                                      return `<<profile \`$npcs[${JSON.stringify(
                                                        npc.key
                                                      )}] \`${JSON.stringify(base)}>>`
                                                    }
