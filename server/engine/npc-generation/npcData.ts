  ...
  raceTraits: {
    "dragonborn": {
      ...
      beard: [
        ...
        `goatee`,
        `well-loved beard, with ornamental beads woven into it`,
        `smattering of hairs on his face`,
        `bit of peach fuzz on his chin`,
        `long, luxurious beard`,
        `long, well-kempt beard`,
        `rather wild, unkempt beard`,
        `dreadful beard`,
      ],
      abilities: {
    ...
    "dwarf": {
      ...
      beard: [
        `scraggly beard`,
        `long, flowing beard`,
        `well-groomed beard going down to his chest`,
        `goatee`,
        `goatee that seems to be trying to level up into a beard`,
        `well-loved beard, with ornamental beads woven into it`,
        `long, luxurious beard`,
        `long, well-kempt beard`,
        `rather wild, unkempt beard`,
