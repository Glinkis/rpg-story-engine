...
export const templeData = {
  ...
  floorPlan: [`circular`, `ellipsoidal`, `triangular`, `square`, `rectangular`, `pentagonal`],
  ...
  rooms: [
    ...
    `a chapel`,
    `a shrine dedicated to a lesser deity, saint, or martyr`,
    `a classroom`,
    `a dormitory`,
    `a library`,
    `a priest’s quarters`,
    `a robing room`,
    `a banquet room, large dining hall,`,
    `a small dining room`,
    `a kitchen`,
    `a trophy room`,
    `an art gallery`,
  ...
  blessingConvey: [
    ...
    `$priest.firstName has you kneel, and then walks around you throwing a chalky powder into the air while chanting softly`,
    ...
    `$priest.firstName takes your hand and slits it open with a silver knife. priest.heshe takes your bleeding palm and spill a few drops into a vat of water while chanting in an unknown language`,
