...
export const misc: Misc = {
  cheese: {
    create() {
      return {
        colour: randomValue(misc.cheese.colour),
        texture: randomValue(misc.cheese.texture),
        taste: randomValue(misc.cheese.taste),
        smell: randomValue(misc.cheese.smell),
        cost: randomValue(misc.cheese.cost),
      }
    },
    colour: [
  ...
  medal: {
    create(base: any = {}) {
      const medal = {
        metal: randomValue(misc.medal.metal),
        material: randomValue(misc.medal.material),
        emblem: randomValue(misc.medal.emblem),
        colour: randomValue(misc.medal.colour),
        ...base,
      }
  ...
  treasureMap: {
    create(base: any = {}) {
      const map = {
        one: randomValue(misc.treasureMap.one),
        two: randomValue(misc.treasureMap.two),
        three: randomValue(misc.treasureMap.three),
        four: randomValue(misc.treasureMap.four),
        five: randomValue(misc.treasureMap.five),
        six: randomValue(misc.treasureMap.six),
        seven: randomValue(misc.treasureMap.seven),
        ...base,
      }
    ...
    one: [
      ...
      "last waterfall on the great river",
      "big well",
    ...
    five: [
      ...
      "great pine tree.",
      "boulder split in two.",
      "enormous sacrificial altar.",
      "unholy temple to a forgotten god.",
    ...
    seven: [
      ...
      "protected by a terrible riddle.",
      "locked behind a holy ward.",
      "buried in an old latrine.",
      "mixed into a dragon's horde.",
      "hidden at the bottom of the chasm.",
      "locked behind arcane spells.",
      "stuck at the top of a great elm tree.",
      "buried in an iron chest.",
      "in a wooden chest in the basement of the cabin.",
      "stuffed in the crack between two boulders.",
      "buried at the end of the black alleyway.",
    ],
  },
  caravan: {
  ...
  ghost: {
    create(base: any = {}) {
      const ghost = {
        profession: randomValue(misc.ghost.profession),
        cause: randomValue(misc.ghost.cause),
        reason: randomValue(misc.ghost.reason),
        release: randomValue(misc.ghost.release),
  ...
  orcs: {
    ...
    create() {
      const orcs: any = {
        ...
        meat: randomValue(misc.orcs.meat),
        fear: randomValue(misc.orcs.fear),
        notorious: randomValue(misc.orcs.notorious),
        knownFor: randomValue(misc.orcs.knownFor),
        attitude: randomValue(misc.orcs.attitude),
        leader: randomValue(misc.orcs.leader),
        goals: randomValue(misc.orcs.goals),
        tactics: randomValue(misc.orcs.tactics),
        pets: randomValue(misc.orcs.pets),
  ...
  goblins: {
    create(base = {}) {
      const goblins: any = {
        business: randomValue(misc.goblins.business),
        symbol: randomValue(misc.goblins.symbol),
        colour: randomValue(misc.goblins.colour),
        lairLocation: randomValue(misc.goblins.lairLocation),
        lairType: randomValue(misc.goblins.lairType),
        target: randomValue(misc.goblins.target),
        currentTarget: randomValue(misc.goblins.currentTarget),
        leaderType: randomValue(misc.goblins.leader),
        goals: randomValue(misc.goblins.goals),
        tactics: randomValue(misc.goblins.tactics),
        accompaniedBy: randomValue(misc.goblins.accompaniedBy),
  ...
  patreonCharacters: {
    ...
    "Galder Fendt": {
      ...
      backgroundOrigin: "",
      note:
        "Galder Fendt is the wizard of /u/SomeHairyGuy, a Reddit user who suffered from advanced pelvic RMS. It's his wish that his character, Galder, be used in games around the world. #CreateAgainstCancer",
    },
    "Brugo Gul'Moth": {
      firstName: "Brugo",
      lastName: "Gul'Moth",
      ...
      hairType: "shiny",
      scar:
        "scars everywhere. Not even in cool places. Just everywhere. Hands, legs, arms, chest, back, neck, face, ears, knees, some too close to the groin.",
      beard: "a quite respectable beard",
      physicalTrait: "a respectable beard",
      ...
      stressTrait:
        "begin to hurt himself when under stress. Scratching, hitting, and biting his lip. Never hurts himself with a weapon or to do permanent damage",
      calmTrait:
      ...
      dndClassOrigin:
        "Brugo has always liked fight. Brugo discover that being punched is most common pain among outsiders. So Brugo decide that is friendliest profession. Brugo tried other pains but outsiders were lot more scared of them. Brugo get respect for good punches for curious reason.",
      backgroundOrigin:
        "Brugo is Son of Gul, Leader of the Cult of Pain. Brugo is of age to be sent on the Pain Quest to discover new methods of pain. Brugo must etch a new scar in ritual mask for each new pain learned.",
