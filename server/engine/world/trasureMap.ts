...
export const treasureMap = {
  ...
  readout(map: TreasureMap) {
    const start = randomValue([`Find the`, `Start at the`])
    return `${start} ${map.one} Then, ${map.two} until you find the ${map.three} Then, ${map.four} until you reach ${map.five} Then, ${map.six} You will find the treasure ${map.seven}`
  },
  one: [
    `big cracked boulder.`,
