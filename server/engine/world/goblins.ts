...
export const goblins = {
  create(base: Partial<Goblins> = {}): Goblins {
    return {
      business: randomValue(goblins.business),
      symbol: randomValue(goblins.symbol),
      colour: randomValue(goblins.colour),
      lairLocation: randomValue(goblins.lairLocation),
      lairType: randomValue(goblins.lairType),
      target: randomValue(goblins.target),
      currentTarget: randomValue(goblins.currentTarget),
      leaderType: randomValue(goblins.leader),
      goals: randomValue(goblins.goals),
      tactics: randomValue(goblins.tactics),
      accompaniedBy: randomValue(goblins.accompaniedBy),
      pets: randomValue(goblins.pets),
      ...base,
    }
  },
