...
export const goblins = {
  create(base?: Partial<Goblins>): Goblins {
    return {
      ...
      lairLocation: randomValue(this.lairLocation),
      lairType: randomValue(this.lairType),
      target: randomValue(this.target),
      currentTarget: randomValue(this.currentTarget),
      leaderType: randomValue(this.leader),
      goals: randomValue(this.goals),
      tactics: randomValue(this.tactics),
      accompaniedBy: randomValue(this.accompaniedBy),
