...
export const books = {
  ...
  condition: [
    ...
    `deliberately damaged. Towards the middle there is a section hollowed out. In this hiding place, you find a ${randomValue(
      [`locket`, `knife`, `small hammer`, `small scroll`, `vial of mysterious liquid`, `ring`]
    )}`,
  ...
  detailedTitles: [
    ...
    // ARCANE STUDIES
    {
      ...
      category: BookCategory.ArcaneStudies,
    ...
    // COLLECTED TALES
    {
      ...
      category: BookCategory.CollectedTales,
    ...
    // TALES AND LEGENDS
    {
      ...
      category: BookCategory.TalesAndLegends,
