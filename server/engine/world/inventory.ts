...
interface Item extends Inventory {
  type: `weapon` | `armour` | `adventuring gear` | `tools` | `consumable`
}

interface Food extends Inventory {
  dietary: `veg` | `omni` | `carni`
}
...
export const inventory: (Item | Food)[] = [
  ...
  { name: `Mess Kit`, cost: 20, availabilityLocation: [`generalStore`], availability: 3, type: `adventuring gear` },
  {
    name: `Steel Mirror`,
    cost: 500,
    availabilityLocation: [`generalStore`],
