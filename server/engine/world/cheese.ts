...
export const cheese = {
  create(base?: Partial<Cheese>): Cheese {
    return {
      ...
      texture: randomValue(this.texture),
      taste: randomValue(this.taste),
      smell: randomValue(this.smell),
      cost: randomValue(this.cost),
      ...base,
    }
  },
  ...
  taste: [
    ...
    `somehow meaty`,
    `earthy and buttery, like sautéed mushrooms`,
